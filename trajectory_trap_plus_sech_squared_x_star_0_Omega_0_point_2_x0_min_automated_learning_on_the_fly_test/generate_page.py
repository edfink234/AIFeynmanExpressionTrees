...
file_parts_display_11 = ['trajectory_data_IC_3_point_008519_1_point_0_0_point_75_1_point_0_0_point_18_Variational_.mp4', 'trajectory_data_IC_2_point_7615_1_point_0_0_point_75_1_point_0_0_point_18_pde_.mp4']
file_parts_display_11_mp4 = file_parts_display_11.copy()
file_parts_display_11 = [extract_parts(filename) for filename in file_parts_display_11]
file_parts_display_11 = [[string_to_float(part) for part in file] for file in file_parts_display_11]
file_parts_display_11_png = [i.replace('.mp4', '.png') for i in file_parts_display_11_mp4]
...
L_val_sol = f"{8.9076}"+r" \times 10^{0}\)"
display_11_strs = (r"\(U_{\text{patched}}(x,\, A = 1,\, \mathcal{A}_0 = 0.75,\, \Omega = 0.18; \, \rho = 0.3333335)\) \(\,\rightarrow \,\mathcal{L} = 2.011102 \times 10^{-2}\)", r"\(V_{\text{sol}}(x, A = 1, b = 0.75, m = 1, \Omega = 0.18)\)  \(\,\rightarrow \,\mathcal{L} = 8.9076 \times 10^{0}\)")
display_11_titles = [*display_11_strs]
...
<div class = "scroll-container" style = "text-align: center">
    <div class="latex-equation">
        $$\begin{align*}
        m \ddot{x} &= -\frac{d}{dx} \left(V(x) \right) \\
        V(x) &= V_{\text{MT}}(x) + V_{\text{sech}}(x-\xi) \\
...
file_data = [
    ...
    {"png": file_parts_display_11_png, "mp4": file_parts_display_11_mp4, "index": 0, "titles": display_11_titles},
]
